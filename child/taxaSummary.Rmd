...
_`r taxa`_ is a member of the `r taxaDat %>% dplyr::pull(!!ensym(taxGroup))` `r tolower(taxGroup)`. Lists and list lengths were defined only for that `r tolower(taxGroup)`.
...
Treating each method and each geographic area as equivalent in determining overall trend, 
